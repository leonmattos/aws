...
public class Service02Stack extends Stack {
    private Table dynamoDbEventProducts;

    public Service02Stack(final Construct scope, final String id, Cluster cluster, SnsTopic productEventsTopic, Table dynamoDbEventProducts) {
        this(scope, id, null, cluster, productEventsTopic, dynamoDbEventProducts);
    }

    public Service02Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic, Table dynamoDbEventProducts) {
        super(scope, id, props);

        Queue productEventsQueueDlq = Queue.Builder.create(this, "ProductEventsDlq")
        ...
        envVariables.put("AWS_REGION", "us-east-2");
        ...
        ApplicationLoadBalancedFargateService service02 = ApplicationLoadBalancedFargateService.Builder.create(this, "ALB02")
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("leonmattos/curso_aws_project02:1.0.0"))
                                .containerPort(9090)
        ...
        dynamoDbEventProducts.grantReadWriteData(service02.getTaskDefinition().getTaskRole());
